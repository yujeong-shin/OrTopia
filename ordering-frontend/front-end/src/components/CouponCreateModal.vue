        ...
        <v-card-text>
          <v-container>
            <v-row>
              ...
              <v-col cols="12">
                <v-text-field v-model="details.rateDiscount" label="할인율 (%)" type="number"></v-text-field>
              </v-col>
              <v-col cols="12">
                <v-text-field v-model="details.fixDiscount" label="정액 할인 (원)" type="number"></v-text-field>
              </v-col>
            </v-row>
          </v-container>
        </v-card-text>
