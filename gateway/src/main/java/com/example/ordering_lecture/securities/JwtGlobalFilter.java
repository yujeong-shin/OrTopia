...
public class JwtGlobalFilter implements GlobalFilter {
    ...
    private final List<String> allowUrl = Arrays.asList("/member/create", "/doLogin", "/item/items","/item/read/{id}","/member/find-id", "/member/reset-password","/member/change-password/**","/payment/success/{email}", "/notices", "/notice/{id}","/payment/cancel","/payment/fail","/review/show_item/{itemId}","/seller/noLogin/{id}","/toss/success","/toss/fail");
